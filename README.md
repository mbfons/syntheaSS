...
To clone the Synthea<sup>TM</sup> repo, then build and run the test suite (if in Windows: powershell):
```
git clone https://github.com/synthetichealth/syntheaSS.git
cd syntheaSS
